        ...
        >
          <div class="">
            ...
            <div class="text-white q-my-sm text-subtitle1">
              Geben Sie Ihre E-Mail-Adresse ein, damit wir Ihnen den Link zum
              Zurücksetzen des Passworts senden können.
            </div>
          </div>
        </div>
      </div>
...
const submitForm = async () => {
  try {
    ...
    showPositive(
      "Ein Link zum Zurücksetzen Ihres Passworts wurde an Ihre E-Mail-Adresse gesendet! Es kann einige Minuten dauern, bis die E-Mail ankommt."
    );
    loading.value = false;
  } catch (error) {
    handleErros(error);
